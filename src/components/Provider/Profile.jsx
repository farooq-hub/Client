         ...
         >
            ...
            <div className="flex-row">
                ...
                <div className="rounded-full  shadow-slate-500  flex h-56 items-center">
                    ...
                    <p className="ml-8 text-2xl font-medium text-slate-600 uppercase underline"> {providerData.name}</p>
                </div>
                <div className="flex-col ml-8 mb-8 text-slate-400">
                    <p className="text-xl my-2 font-medium text-slate-400">@{providerData.name}</p>
                    <p className="text-lg my-2 font-medium text-slate-500"> {providerData.description}</p>
                
                    <p className="text-lg text-slate-500"> Serviesing in : </p>
                    <p className="text-base ml-3 font-medium text-slate-400">
                    ...
                    </p>
                    {
                        ...
                        <div className="flex my-2" >
                            <MdOutlineLocationOn className="text-blue-500 mr-2"/>
                            <p className="text-gray-500">{providerData.location}</p>
                        </div>    
                    }
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12">
            ...
            <div className="hidden md:block col-span-4 bg-white border-l-2 ">
                ...
                <div className="w-full  cursor-pointer ">
                    <ul className="flex flex-col h-56 md:h-3/4 gap-x-8 mt-4 ml-4">
                        {
                            providerData.services && providerData.services.map((val) => {
                                return (
                                    <li key={val._id} className="relative mx-auto flex flex-col items-center shadow-md border  justify-center overflow-hidden  rounded-2xl w-[400px] mb-4  h-56 object-cover" 
                                    style={{ backgroundImage: `url(${val.serviceImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                                        <div className="absolute inset-0 bg-gradient-to-t from-gray-900 via-gray-900/40 w-auto" ></div>
                                        <h3 className="z-10 text-3xl font-bold text-slate-100 font-serif">{val.serviceName}</h3>
                                        <h3 className="z-10 overflow-hidden text-sm leading-6 text-slate-300">{val.description ?val.description:''}</h3>
